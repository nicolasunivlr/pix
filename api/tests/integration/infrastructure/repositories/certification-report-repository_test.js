...
const { databaseBuilder, expect, catchErr } = require('$root/tests/test-helper');
const CertificationReport = require('$root/lib/domain/models/CertificationReport');
const certificationReportRepository = require('$root/lib/infrastructure/repositories/certification-report-repository');
const { CertificationCourseUpdateError } = require('$root/lib/domain/errors');
