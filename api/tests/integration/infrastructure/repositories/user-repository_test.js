...
describe('Integration | Infrastructure | Repository | UserRepository', () => {
  ...
  describe('#updateTemporaryPassword', () => {
    ...
    it('should save the user', async () => {
      ...
      // when
      const updatedUser = await userRepository.updateTemporaryPassword(userInDb.id, generatedPassword);
    ...
    it('should throw UserNotFoundError when user id not found', async () => {
      ...
      // when
      const error = await catchErr(userRepository.updateTemporaryPassword)(wrongUserId, generatedPassword);
