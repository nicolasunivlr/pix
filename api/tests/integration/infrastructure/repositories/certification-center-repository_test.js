const { expect, knex, databaseBuilder } = require('$root/tests/test-helper');
const certificationCenterRepository = require('$root/lib/infrastructure/repositories/certification-center-repository');
