const { expect, databaseBuilder, domainBuilder, airtableBuilder } = require('$root/tests/test-helper');
const campaignCollectiveResultRepository = require('$root/lib/infrastructure/repositories/campaign-collective-result-repository');
