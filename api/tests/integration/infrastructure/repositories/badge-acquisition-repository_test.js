...
const BadgeAcquisition = require('$root/lib/domain/models/BadgeAcquisition');
const badgeAcquisitionRepository = require('$root/lib/infrastructure/repositories/badge-acquisition-repository');
