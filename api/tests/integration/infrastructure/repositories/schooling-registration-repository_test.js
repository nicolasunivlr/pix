const { expect, databaseBuilder, knex, catchErr } = require('$root/tests/test-helper');
...
const UserWithSchoolingRegistration = require('$root/lib/domain/models/UserWithSchoolingRegistration');

const { NotFoundError, SameNationalStudentIdInOrganizationError } = require('$root/lib/domain/errors');
