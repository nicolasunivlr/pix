...
const organisationInvitationController = require('$root/lib/application/organization-invitations/organization-invitation-controller');
const route = require('$root/lib/application/organization-invitations/index');
