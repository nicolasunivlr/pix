...
const { expect, databaseBuilder, catchErr } = require('$root/tests/test-helper');
...
const createAndAssociateUserToSchoolingRegistration = require('$root/lib/domain/usecases/create-and-associate-user-to-schooling-registration');
