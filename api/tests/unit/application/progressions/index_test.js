...
const progressionController = require('$root/lib/application/progressions/progression-controller');
...
describe('Unit | Router | progression-router', () => {
  ...
  beforeEach(() => {
    ...
    server = Hapi.server();
    return server.register(require('$root/lib/application/progressions'));
  });
