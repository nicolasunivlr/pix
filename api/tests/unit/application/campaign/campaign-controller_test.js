...
const campaignController = require('$root/lib/application/campaigns/campaign-controller');

const campaignSerializer = require('$root/lib/infrastructure/serializers/jsonapi/campaign-serializer');
const campaignAnalysisSerializer = require('$root/lib/infrastructure/serializers/jsonapi/campaign-analysis-serializer');
const campaignReportSerializer = require('$root/lib/infrastructure/serializers/jsonapi/campaign-report-serializer');
const campaignCollectiveResultSerializer = require('$root/lib/infrastructure/serializers/jsonapi/campaign-collective-result-serializer');
