const getCorrectionForAnswer = require('$root/lib/domain/usecases/get-correction-for-answer');
...
const { AssessmentNotCompletedError, NotFoundError } = require('$root/lib/domain/errors');
