...
const findAnswerByAssessment = require('$root/lib/domain/usecases/find-answer-by-assessment');
const { UserNotAuthorizedToAccessEntity, EntityValidationError } = require('$root/lib/domain/errors');
