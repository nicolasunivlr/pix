const updateUserOrgaSettings = require('$root/lib/domain/usecases/update-user-orga-settings');
const { expect, catchErr, sinon } = require('$root/tests/test-helper');
const { UserNotMemberOfOrganizationError } = require('$root/lib/domain/errors');
