...
const getNextChallengeForSmartPlacement = require('$root/lib/domain/usecases/get-next-challenge-for-smart-placement');
const smartRandom = require('$root/lib/domain/services/smart-random/smart-random');
const { FRENCH_SPOKEN } = require('$root/lib/domain/constants').LOCALE;
