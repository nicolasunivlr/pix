const { sinon, expect, domainBuilder, catchErr } = require('$root/tests/test-helper');
const { NotFoundError, UserNotAuthorizedToAccessEntity, CampaignAlreadyArchivedError } = require('$root/lib/domain/errors');
const usecases = require('$root/lib/domain/usecases');
const smartRandom = require('$root/lib/domain/services/smart-random/smart-random');
