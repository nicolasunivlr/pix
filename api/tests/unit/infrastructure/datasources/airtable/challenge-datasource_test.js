...
const challengeAirtableDataObjectFixture = require('$root/tests/tooling/fixtures/infrastructure/challengeAirtableDataObjectFixture');
const challengeRawAirTableFixture = require('$root/tests/tooling/fixtures/infrastructure/challengeRawAirTableFixture');
