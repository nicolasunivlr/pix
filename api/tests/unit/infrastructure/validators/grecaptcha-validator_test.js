...
const gRecaptcha = require('$root/lib/infrastructure/validators/grecaptcha-validator');
const { InvalidRecaptchaTokenError } = require('$root/lib/domain/errors');
const logger = require('$root/lib/infrastructure/logger');
const { captcha } = require('$root/lib/config');
