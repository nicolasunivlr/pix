const { expect, domainBuilder, EMPTY_BLANK_AND_NULL } = require('$root/tests/test-helper');
const serializer = require('$root/lib/infrastructure/serializers/jsonapi/certification-serializer');
const { WrongDateFormatError } = require('$root/lib/domain/errors');
const { NO_EXAMINER_COMMENT } = require('$root/lib/domain/models/CertificationReport');
