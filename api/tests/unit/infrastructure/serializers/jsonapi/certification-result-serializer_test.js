...
const serializer = require('$root/lib/infrastructure/serializers/jsonapi/certification-result-serializer');
const CertificationResult = require('$root/lib/domain/models/CertificationResult');
