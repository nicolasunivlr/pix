...
module.exports = function(environment) {
  const ENV = {
    ...
    APP: {
      ...
      IS_STAGING_BANNER_ENABLED: process.env.IS_STAGING_BANNER_ENABLED === 'true',
      IS_PROD_HAVING_PROBLEMS_BANNER_ENABLED: process.env.IS_PROD_HAVING_PROBLEMS_BANNER_ENABLED === 'true',
